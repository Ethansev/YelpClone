...
const {campgroundSchema} = require('./schemas.js'); //eventually want to add more schemas so we're destrucuring
...
app.delete('/campgrounds/:id', async(req, res) => {
    //deletes the campground at id and redirects back to the main page
    const { id } = req.params;
